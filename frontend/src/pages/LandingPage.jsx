  ...
  const features = [
    {
      ...
      description: 'AI-powered maintenance scheduling and predictive analytics to prevent equipment failures.'
    },
    {
      icon: Users,
      title: 'Team Management',
      description: 'Organize technicians, managers, and teams with role-based access and permissions.'
    },
    {
      icon: BarChart3,
      title: 'Real-time Analytics',
      description: 'Track performance metrics, maintenance costs, and equipment health in real-time.'
    },
    {
      icon: Clock,
      title: 'Automated Workflows',
      description: 'Streamline maintenance processes with automated task assignment and notifications.'
    }
  ];

  const stats = [
    { number: '99.9%', label: 'Uptime Guaranteed' },
    { number: '50%', label: 'Faster Repairs' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              The Ultimate
              <span className="text-emerald-400 block">Maintenance Tracker</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Streamline your maintenance operations with intelligent scheduling, 
              real-time tracking, and powerful analytics. Keep your equipment running 
              at peak performance.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/auth/signup"
                className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors flex items-center justify-center"
              >
                Start Free Trial
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Everything you need to manage, track, and optimize your maintenance operations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-emerald-500/50 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-emerald-500/20 to-blue-500/20 rounded-xl p-6 border border-gray-700">
                <Zap className="w-8 h-8 text-emerald-400 mb-3" />
                <h3 className="text-lg font-semibold text-white mb-2">Lightning Fast</h3>
                <p className="text-gray-300 text-sm">Optimized for speed and performance</p>
              </div>
              <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-xl p-6 border border-gray-700">
                <Target className="w-8 h-8 text-blue-400 mb-3" />
                <h3 className="text-lg font-semibold text-white mb-2">Precision</h3>
                <p className="text-gray-300 text-sm">Accurate tracking and reporting</p>
              </div>
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl p-6 border border-gray-700">
                <Globe className="w-8 h-8 text-purple-400 mb-3" />
                <h3 className="text-lg font-semibold text-white mb-2">Global Scale</h3>
                <p className="text-gray-300 text-sm">Works across multiple locations</p>
              </div>
              <div className="bg-gradient-to-br from-pink-500/20 to-emerald-500/20 rounded-xl p-6 border border-gray-700">
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of companies already using GearGuard to optimize their maintenance workflows.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/auth/signup"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                The ultimate maintenance management platform. Streamline operations, 
                reduce downtime, and optimize your equipment performance.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/technician" className="text-gray-400 hover:text-emerald-400 transition-colors">Dashboard</Link></li>
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Analytics</a></li>
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Reporting</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Manufacturing</a></li>
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Healthcare</a></li>
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Facilities</a></li>
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Transportation</a></li>
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Energy</a></li>
